...
export function Environment(name: string): BaseURL {
  return `https://${name}-appointment-setting-emki.encr.app`;
}
...
/**
 * Client is an API client for the appointment-setting-emki Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "appointment-setting-emki-Generated-TS-Client (Encore/v1.28.0)",
    };
